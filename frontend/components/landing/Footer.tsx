// ============================================================
// COMPONENT: Footer — Landing page footer
...
export default function Footer() {
  return (
    <footer className="relative bg-[#060612] border-t border-white/[0.06]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-gray-500 max-w-xs leading-relaxed mb-6">
              Modern payroll management platform for businesses of all sizes.
            ...
            <div className="flex items-center gap-3">
              {[TwitterIcon, GitHubIcon, LinkedInIcon].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="h-9 w-9 rounded-lg bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-gray-500 hover:text-white hover:bg-white/[0.08] hover:border-white/[0.1] transition-all duration-200"
                >
                  <Icon />
                </a>
              ))}
